...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Adjust| Esc  |      | Alt  | LGUI |Lower |Space |Space |Raise | RGUI | Left | Down |  Up  |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      ...
      ADJUST,         KC_ESC,  KC_NO, KC_LALT, KC_LGUI,   LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_RGUI, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
  ...
  [_LOWER] = LAYOUT( \
      ...
      KC_CAPS, _______, _______, _______, _______, _______,                   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_QUOT, KC_PIPE, \
      _______, _______, _______, _______, _______, _______, KC_LPRN, KC_RPRN, _______, _______, _______, KC_HOME, KC_END,  _______, \
      _______, _______, _______, _______, _______, _______, _______, KC_MPLY, _______, _______, MEDIAPREV, VOLDN, VOLUP,   MEDIANEXT \
      ),
  ...
  [_RAISE] = LAYOUT( \
      ...
      _______, _______, _______, _______, _______, _______,                   KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_DQUO, _______, \
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case MEDIAPREV:
      if (record->event.pressed) {
        if(keymap_config.swap_lalt_lgui==false){
          SEND_STRING(SS_TAP(X_MEDIA_REWIND));
        }else{
