...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,          LT(2, KC_UP),   KC_PGDN, \
    ...
    [1] = LAYOUT(
        ...
        KC_CAPS,  L_PSD,   L_BRI,   L_PSI,   L_T_BR, U_T_AUTO, U_T_AGCR, KC_NO,KC_UP,KC_NO, KC_PSCR, KC_SLCK, KC_PAUS, KC_TRNS, KC_END, \
        L_T_PTD, L_PTP,   L_BRD,   L_PTN,   KC_TRNS, KC_TRNS, KC_NO, KC_LEFT, KC_DOWN, KC_RIGHT, KC_NO, KC_TRNS,          KC_TRNS, KC_VOLU, \
